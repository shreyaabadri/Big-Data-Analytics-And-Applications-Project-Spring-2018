...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("breakfast_burrito", "chicken_curry", "chocolate_cake", "french_fries", "garlic_bread", "hot_dog", "lasagna", "onion_rings", "pancakes")
  ...
  def main(args: Array[String]) {
    ...
    println("Accuracy of Random forest Model :"+accuracy)
